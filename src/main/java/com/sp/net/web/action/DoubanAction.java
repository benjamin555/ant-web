...
public class DoubanAction  extends ActionSupport {
	private Logger logger = LoggerFactory.getLogger(DoubanAction.class);
	...
	public String login() throws Exception {
		doubanSite.login(userName,password,vcode);
		return RULES;
	}
